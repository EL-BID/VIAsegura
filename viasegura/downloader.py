...
class Downloader:
    ...
    def check_artifacts(self):
        ...
        if not Path(self.models_path).is_dir():
            raise ImportError(
                "The route for the models is not present, it means that the models are not downloaded on this "
                "environment, use viasegura.download_models function to download them propertly"
            )
